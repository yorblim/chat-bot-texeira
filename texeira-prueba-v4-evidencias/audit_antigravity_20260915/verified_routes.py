        ...
        if eid and fld and lang in {'es','en'}:
            ...
            for f in selected:
                ...
                if eid=='machu-picchu-tren' and f.field in {'includes','excludes'}:
                    ...
                    val=val.replace('días','days').replace('dias','days').replace('horas','hours')
                    if 'itinerario publicado' in val:
                        val='4 days (published itinerary; confirm variant and nights)'
