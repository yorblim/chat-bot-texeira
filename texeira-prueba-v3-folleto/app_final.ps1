...
# Detectar consultas sobre condiciones comerciales no confirmadas
        ...
        if any(kw in q_lower for kw in ["cupo", "cupos", "disponibilidad", "reserva", "reservar", "confirmar reserva", "availability", "reservation", "book", "booking"]):
            needs_agency_conf = True
        ...
        if agency_contact and ('contactar' in response_text.lower() or 'contacta' in response_text.lower() or 'canales oficiales' in response_text.lower()) and '+51' not in response_text:
